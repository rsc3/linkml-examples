# Contributing to linkml-examples

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
linkml-examples. These guidelines are not strict rules.
...
The linkml-examples team strives to create a
...
[issues]: https://github.com/my-org/linkml-examples/issues/
[pulls]: https://github.com/my-org/linkml-examples/pulls/
