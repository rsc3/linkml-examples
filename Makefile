...
examples/output: src/linkml_examples/schema/linkml_examples.yaml
	mkdir -p $@
...
git-init:
	git init
git-add: .cruft.json
	git add .gitignore .github .cruft.json Makefile LICENSE *.md examples utils about.yaml mkdocs.yml poetry.lock project.Makefile pyproject.toml src/linkml_examples/schema/*yaml src/*/datamodel/*py src/data src/docs tests src/*/_version.py
